...
describe("Testing Calculate(minutes) function: Using Boundary & MC/DC testing", function() {
	...
	describe("Valid value cases, user not use any sale pack", function(){
	    ...
	    { 
	        expect( calculate(51, "none") ).toBe( 55400 ); 
	    });
	    ...
	    { 
	        expect( calculate(199.9999, "none") ).toBe( 114999.95999999999 ); 
	    });
	    ...
	    { 
	        expect( calculate(201, "none") ).toBe( 115200 ); 
	    });
	});

	//Three test case using MC / DC method
