...
public class TinhTongTest {
    ...
    public void testMCDC3() {
        ...
        TinhTong tong1 = new TinhTong( 3, 4, 6);
        TinhTong tong2 = new TinhTong( 2, 3, 6);
    ...
    public void testMCDC4() {
        ...
        TinhTong tong1 = new TinhTong( 3, 4, 5);
        TinhTong tong2 = new TinhTong( 1, 3, 5);
        int sum1 = tong1.tinhTong();
        int sum2 = tong2.tinhTong();
        assertEquals(1200, sum1);
        assertEquals(1683, sum2);
    }
    
    @Test
    public void testMCDC5() {
        // A false, B false and C true
        TinhTong tong = new TinhTong( 1, 4, 6);        
        int sum = tong.tinhTong();
    ...
    public void testMCDC6() {
        ...
        TinhTong tong = new TinhTong( 1, 4, 5);        
        int sum = tong.tinhTong();
