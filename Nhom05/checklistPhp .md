...
Bộ quy tắc này được tạo ra nhằm giảm bớt những khó khăn trong việc đọc code của người khác.
Nó thực hiện điều đó bằng cách đặt ra những quy định hay gợi ý về việc format PHP code.
Các quy tắc phong cách ở đây đều được bắt nguồn từ sự tương đồng giữa các dự án thành viên khác nhau.
Khi tác giả khác nhau hợp tác trên nhiều dự án, nó sẽ giúp bạn có một bộ các hướng dẫn được sử dụng trong tất cả các dự án này. 
Như vậy, lợi ích của hướng dẫn này không có trong quy tắc bản thân, nhưng trong việc chia sẻ những quy tắc. 
...
- Dấu mở ngặc nhọn dùng khi khai báo phải được viết ở dòng mới (không viết cùng dòng với phần khai báo tên method), 
...
method.
Không được có khoảng trắng sau dấu mở ngoặc đơn, và không được có khoảng trắng phía trước dấu đóng ngặc đơn.
...
- Phải có một khoảng trắng sau dấu đóng ngoặc đơn và trước dấu mở ngoặc nhọn
...
Closures phải được định nghĩa mới một khoảng trắng phía sau keywork `function`, và một khoảng trắng ở phía trước và phía sau của keywork `use`.
...
Cách định nghĩa một closure trông như sau. Hãy chú ý vào vị trí của dấu ngoặc đơn, dấu phẩy, khoảng trắng và dấu ngoặc nhọn.
...
Danh sách argument và danh sách variable có thể được tách ra làm nhiều dòng, trong đó mỗi dòng tiếp theo được lùi vào 
một khoảng. Khi làm như vậy thì argument hay variable đầu tiên phải được đặt ở trên một dòng mới, và mỗi dòng chỉ được phép
chứa một argument hay một variable.

Khi kết thúc danh sách (kể cả arguments hay variables) thì chia thành nhiều dòng, dấu đóng ngoặc đơn và dấu mở ngoặc nhọn
phải được đặt cùng nhau trên một dòng, với một khoảng trắng ở giữa.
...
Có rất nhiều yếu tố về style hay kinh nghiệm (practices) khác được cố tình bỏ qua trong hướng dẫn này. Có thể kể ra như:
...
- Khối chú thích (Comments) và tài liệu (0Documentation) 

- Tiền tố và hậu tố trong tên Class

- Best practices

Trong khi viết hướng dẫn style này, nhóm đã khảo sát các thành viên trong dự án để xác định những kinh nghiệm, thông lệ chung. 
Cuộc khảo sát được giữ lại làm tài liệu tham khảo cho những người mới.