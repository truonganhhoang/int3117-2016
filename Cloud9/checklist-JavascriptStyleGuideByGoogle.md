...
JSDoc sử dụng trên tất cả classes, fields, and methods.

### 7.1 General form

- Các định dạng cơ bản của khối JSDoc được trình bày như trong ví dụ:
...
- Hoặc trong ví dụ một dòng sau đây:
...
- Nếu một comment đơn dòng tràn vào nhiều dòng, ta phải sử dụng phong cách nhiều dòng /** và */ .
